#include "Scene_023_ComputeShaderGridPatern.h"
...
Scene_023_ComputeShaderGridPatern::Scene_023_ComputeShaderGridPatern() {
...
void Scene_023_ComputeShaderGridPatern::setGame(Game *_game) {
    game = _game;
}

void Scene_023_ComputeShaderGridPatern::clean() {
    delete quadTexture;
    delete quadVertex;
    delete quadIndex;
}

void Scene_023_ComputeShaderGridPatern::pause() {
}

void Scene_023_ComputeShaderGridPatern::resume() {
}

void Scene_023_ComputeShaderGridPatern::handleEvent(const InputState &inputState) {

}

void Scene_023_ComputeShaderGridPatern::load() {
...
void Scene_023_ComputeShaderGridPatern::update(float dt) {

}

void Scene_023_ComputeShaderGridPatern::draw()
{
